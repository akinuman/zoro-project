...
export type CompAccruedAdjustedEventFilter =
  TypedEventFilter<CompAccruedAdjustedEvent>;
...
export type CompReceivableUpdatedEventFilter =
  TypedEventFilter<CompReceivableUpdatedEvent>;
