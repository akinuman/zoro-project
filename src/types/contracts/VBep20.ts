...
export interface VBep20Interface extends utils.Interface {
  ...
  events: {
    ...
    "RedeemFee(address,uint256,uint256)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "RedeemFee"): EventFragment;
...
export interface RedeemFeeEventObject {
  redeemer: string;
  feeAmount: BigNumber;
  redeemTokens: BigNumber;
}
export type RedeemFeeEvent = TypedEvent<
  [string, BigNumber, BigNumber],
  RedeemFeeEventObject
>;

export type RedeemFeeEventFilter = TypedEventFilter<RedeemFeeEvent>;
...
export interface VBep20 extends BaseContract {
  ...
  functions: {
    ...
    liquidateBorrow(
      ...
      vTokenCollateral: PromiseOrValue<string>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
