...
import type { VenusLens, VenusLensInterface } from "../VenusLens";
...
export class VenusLens__factory {
  static readonly abi = _abi;
  static createInterface(): VenusLensInterface {
    return new utils.Interface(_abi) as VenusLensInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): VenusLens {
    return new Contract(address, _abi, signerOrProvider) as VenusLens;
  }
}
