...
import type { VEther, VEtherInterface } from "../VEther";
...
export class VEther__factory {
  static readonly abi = _abi;
  static createInterface(): VEtherInterface {
    return new utils.Interface(_abi) as VEtherInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): VEther {
    return new Contract(address, _abi, signerOrProvider) as VEther;
  }
}
